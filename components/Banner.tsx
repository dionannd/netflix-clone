...
const Banner: React.FC<Props> = ({ netflixOriginals }: Props) => {
  ...
  return (
    <div className="flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[65vh]  lg:justify-end lg:space-y-6 lg:pb-12">
      ...
      <div className="flex space-x-3">
        <button className="text-black bg-white banner-button">
